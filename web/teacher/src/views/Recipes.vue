    ...
    <el-card>
      ...
      <el-form :inline="true" class="query-form">
        <el-form-item label="星期">
          <el-select v-model="queryForm.weekDay" placeholder="全部" clearable @change="getList">
...
import { createRecipe, getRecipes } from '@/api/teacher'
...
const queryForm = reactive({ page: 1, size: 10, weekDay: null })
...
const getList = async () => {
  loading.value = true
  try {
    const res = await getRecipes(queryForm)
